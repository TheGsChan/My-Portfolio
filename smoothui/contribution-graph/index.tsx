...
const createDayData = (
  ...
  // Use explicit local timezone formatting to prevent UTC offset day-drifting
  ...
  return {
    ...
    isToday: existingData?.isToday,
    isBlinking: existingData?.isBlinking,
  };
};
                    ...
                    >
                      <div
                        className={`h-5 w-5 rounded-sm
                           ...
                           } hover:ring-2 hover:ring-background ${dayData.isBlinking ? 'animate-pulse ring-2 ring-[#39D353] shadow-[0_0_8px_#39D353] z-10 relative' : ''}`}
                      />
                    </td>
                  );
                })}
